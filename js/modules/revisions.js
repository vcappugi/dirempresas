    ...
    if (revisionsViewMode === "calendar") {
      ...
      if (revisionsList.length === 0) {
        ...
        revisionsList.forEach(item => {
          ...
          const btnEditar = `
            <button onclick="editRevision(${item.id})" class="inline-flex items-center justify-center p-1.5 rounded-lg text-brand bg-brand/10 hover:bg-brand/20 dark:text-brand-light dark:bg-brand/15 dark:hover:bg-brand/25 transition-all duration-200 shadow-sm border border-brand/20 dark:border-brand/30" title="Editar Revisión">
          ...
          const btnVer = `
            <button onclick="editRevision(${item.id})" class="inline-flex items-center justify-center p-1.5 rounded-lg text-brand bg-brand/10 hover:bg-brand/20 dark:text-brand-light dark:bg-brand/15 dark:hover:bg-brand/25 transition-all duration-200 shadow-sm border border-brand/20 dark:border-brand/30" title="Ver Detalles">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          row.innerHTML = `
            ...
            <td class="px-4 py-3 font-semibold text-slate-800 dark:text-white font-mono">${item.id}</td>
            <td class="px-4 py-3 text-slate-700 dark:text-slate-200 font-semibold">${empresaName}</td>
            <td class="px-4 py-3 text-slate-650 dark:text-slate-200 font-mono text-xs">${fechaRevText}</td>
            <td class="px-4 py-3 text-slate-600 dark:text-slate-400 text-xs">${descText}</td>
            <td class="px-4 py-3 text-slate-600 dark:text-slate-400 text-xs">${compromisoText}</td>
            <td class="px-4 py-3 text-slate-650 dark:text-slate-200 font-mono text-xs">${fechaCompText}</td>
            <td class="px-4 py-3 text-center">${cumplidoBadge}</td>
            <td class="px-4 py-3 text-center">${anexoLink}</td>
          `;
